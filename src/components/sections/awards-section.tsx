...
const awardsData: AwardItem[] = [
  {
    ...
    selected: true,
    icon: Medal,
    image: "/awards/1.presidential-science-scholarship-2024.png",
  },
  {
    id: 2,
    ...
    selected: false,
    icon: Medal,
    image: "/awards/2.dongil-culture-scholarship-foundation-2024.png",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    selected: false,
    icon: Award,
    image: "/awards/4.deans-fall-2024.png",
  },
  {
    id: 5,
    ...
    selected: false,
    icon: Award,
    image: "/awards/5.deans-spring-2024.png",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    icon: Medal,
    image: "/awards/8.ipesk-next-generation-engineering-talent-2025.png",
  },
  {
    id: 9,
    title: "KAIST Opensource Impact (KOI) Contest 2026 | 2nd Place",
    organization: "KAIST SW Education Center",
    description: "Awarded 2nd place in the KOI Contest 2026, a six-week hackathon-style program where around 30 selected students make real-world contributions to the open-source ecosystem leveraging modern AI coding tools.",
    year: 2026,
    month: 6,
    selected: false,
    link: "/work/projects?highlight=3",
    icon: Trophy,
    image: "/awards/9.kaist-opensource-impact-2026.jpg",
  },
  {
    id: 10,
    title: "2026 Hyundai Motor Chung Mong-Koo Scholarship (Science and Technology)",
    organization: "Hyundai Motor Chung Mong-Koo Foundation",
    description: "Recipient of the 2026 Hyundai Motor Chung Mong-Koo Scholarship (graduate division), awarded to 20 students nationwide, providing full tuition and research support to foster next-generation leaders in science and technology.",
    year: 2026,
    month: 7,
    selected: true,
    link: "",
    icon: Medal,
    image: "/awards/10.hyundai-motor-chung-mong-koo-scholarship-2026.jpg",
  },
]
