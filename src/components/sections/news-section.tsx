...
const newsData: NewsItem[] = [
  ...
  },
  {
    year: 2026,
    month: 6,
    content: "🥈 Won 2nd place at KAIST Opensource Impact (KOI) Contest 2026!",
    type: "award",
    link: "/work/awards?highlight=9",
  },
  {
    year: 2026,
    month: 3,
    content: "🍾 BitTP accepted to CVPR 2026 Findings!",
    type: "publication",
    link: "/work/publications?highlight=3",
  },
  {
    year: 2026,
    month: 3,
