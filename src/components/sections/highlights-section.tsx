...
const highlights = [
  {
    ...
    subtitle: "CVPR26 Findings",
    content: "BitTP was accepted at CVPR 2026 Findings — a lightweight trajectory prediction model using BitLLM, designed for edge-device deployment.",
  ...
  },
  {
    ...
    content: "ChatTree: a Chrome extension that visualizes Claude.ai conversations as an interactive tree-map, enabling click-to-jump navigation across branching chat sessions.",
    link: "/work/projects",
  ...
  },
  {
    ...
    subtitle: "2026",
    content: "Won 2nd Place at the KAIST Opensource Impact (KOI) Contest 2026 with ChatTree, a Chrome extension for navigating Claude.ai conversations.",
    link: "/work/awards",
